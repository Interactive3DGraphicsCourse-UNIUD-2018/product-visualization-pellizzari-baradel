...
function modificaRGB1(){
		...
		switch(componenteRGB){
			case 0:
				uniformsDinamico.clight.value.x = valoreComponente;
				uniformsDinamico.clight.needsUpdate = true;
				lucePuntuale.material.color.r = valoreComponente;
				break;
			case 1:
...
function modificaRGB2(){
		...
		switch(componenteRGB){
			case 0:
				uniformsDinamico.clight2.value.x = valoreComponente;
				uniformsDinamico.clight2.needsUpdate = true;
				lucePuntuale2.material.color.r = valoreComponente;
				break;
			case 1:
